      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <a href="doctor.php" style="text-decoration:none;color:white">
              <div class="card-body py-5"> Our Doctors</div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <a href="patient.php" style="text-decoration:none;color:white">
              <div class="card-body py-5">Our patient</div>
              <div class="card-footer d-flex">
                View Details
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
